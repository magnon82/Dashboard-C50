...
export const ADMIN_SYNC_SCHEDULES: AdminSyncSchedule[] = [
  ...
  },
  {
    ...
    feeds:
      'cxp + cxp_saldos + presupuesto_* + estado_mifel/bbva (Excel) + ventas_semana',
    mode: 'cloud',
    ...
    note:
      'Descarga Excel de presupuesto, estados y Acumulado ventas x semana desde Drive; CxP histórico desde Sheets. Ajustes /admin (presupuesto_ajuste, saldos_bancos_manual) siguen manuales. Índices PDF: reindex en Suite o PC. Eventos legacy: ingest puntual aparte.',
  },
  {
    id: 'bancos-pdf',
